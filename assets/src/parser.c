...
layer parse_yolo(list *options, size_params params)
{
    ...
    else if (strcmp(iou_loss, "qiou") == 0) l.iou_loss = QIOU;
    else if (strcmp(iou_loss, "diou") == 0) l.iou_loss = DIOU;
    else if (strcmp(iou_loss, "ziou") == 0) l.iou_loss = ZIOU;
    else l.iou_loss = IOU;
    ...
    else if (strcmp(iou_thresh_kind_str, "qiou") == 0) l.iou_thresh_kind = QIOU;
    else if (strcmp(iou_thresh_kind_str, "diou") == 0) l.iou_thresh_kind = DIOU;
    else if (strcmp(iou_thresh_kind_str, "ziou") == 0) l.iou_thresh_kind = ZIOU;
    else {
    ...
    l.track_ziou_norm = option_find_float_quiet(options, "track_ziou_norm", 0.01);
