...
//#endif
    ...
    if (iou_loss == QIOU) {
      if (qiou_C > 0) {
        ...
        p_dt += ((qiou_C * dU_wrt_t) - (U * dC_wrt_t)) / (qiou_C * qiou_C);
        p_db += ((qiou_C * dU_wrt_b) - (U * dC_wrt_b)) / (qiou_C * qiou_C);
        p_dl += ((qiou_C * dU_wrt_l) - (U * dC_wrt_l)) / (qiou_C * qiou_C);
        p_dr += ((qiou_C * dU_wrt_r) - (U * dC_wrt_r)) / (qiou_C * qiou_C);
      }
	  if (Iw<=0||Ih<=0) {
		p_dt = ((qiou_C * dU_wrt_t) - (U * dC_wrt_t)) / (qiou_C * qiou_C);
        p_db = ((qiou_C * dU_wrt_b) - (U * dC_wrt_b)) / (qiou_C * qiou_C);
